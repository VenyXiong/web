(window.MIP = window.MIP || []).push({
    name: "mip-chuangyejia-tabs", func: function () {// ======================
            ...
            IScroll.prototype = {
                ...
                _translate: function (x, y) {
                    if (this.options.useTransform) {
                        ...
                        this.scrollerStyle[utils.style.transform] = 'translate(' + x + 'px,' + y + 'px)' + this.translateZ;    /* REPLACE END: _translate */
                    } else {
                        x = Math.round(x);
                        y = Math.round(y);
                ...
                _key: function (e) {
                    ...
                    var snap = this.options.snap,
                        ...
                        newX = snap ? this.currentPage.pageX : this.x, newY = snap ? this.currentPage.pageY : this.y, now = utils.getTime(), prevTime = this.keyTime || 0, acceleration = 0.25, pos;
                    if (this.options.useTransition && this.isInTransition) {
                        pos = this.getComputedPosition();
                        this._translate(Math.round(pos.x), Math.round(pos.y));
                        this.isInTransition = false;
        ...
        define('mip-chuangyejia-tabs/mip-chuangyejia-tabs', [
            ...
            // // var log = console.log.bind(window)
            // 辅助方法
            ...
            customElement.prototype.firstInviewCallback = function () {
                ...
                var navItem = tools.queryAll('li', navWrapper);
                var contentItem = tools.queryAll('li', contentWrapper);
                // 拦截默认滑动
                ...
                var perNavWidth = Math.floor(rect.getElementRect(navItem[0]).width);
                var navWidth = perNavWidth * navItem.length;
                tools.query('ul', navWrapper).style.width = navWidth + 'px';
                var perContentWidth = Math.floor(rect.getElementRect(contentWrapper).width);
                var contentWidth = perContentWidth * navItem.length;
                tools.query('ul', contentWrapper).style.width = contentWidth + 'px';
                ...
                // 初始化 iscroll
                setTimeout(function () {
                    var navScroll = new Iscroll(navWrapper, {
                        scrollX: true,
                        scrollY: false,
                        snap: 'li',
                        snapSpeed: 400,
                    ...
                    var contentScroll = new Iscroll(contentWrapper, {
                        scrollX: true,
                        scrollY: false,
                        snap: 'li',
                        snapSpeed: 400,
                    ...
                    // 代理nav点击
                    navWrapper.addEventListener('tap', updateTab, false);
                    ...
                    function addActiveClass (index) {
                        if (index === undefined) {
                            var nowPage = contentScroll.currentPage.pageX;
                    ...
                    function moveContent (index) {
                        contentScroll.goToPage(index, 0, 300);
                    }
                }, 20);
            };
        ...
        (function () {
            function registerComponent (mip, component) {
                mip.registerMipElement("mip-chuangyejia-tabs", component, "mip-chuangyejia-tabs .tabs-nav-wrapper,mip-chuangyejia-tabs .tabs-content-wrapper{width:100%;overflow:hidden}mip-chuangyejia-tabs .tabs-nav-wrapper ul,mip-chuangyejia-tabs .tabs-content-wrapper ul{position:relative;width:100%;height:100%;z-index:1;display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-transition-property:-webkit-transform;transition-property:-webkit-transform;-o-transition-property:transform;transition-property:transform;transition-property:transform,-webkit-transform;-webkit-box-sizing:content-box;box-sizing:content-box}mip-chuangyejia-tabs .tabs-nav-wrapper li,mip-chuangyejia-tabs .tabs-content-wrapper li{width:80px;height:30px;text-align:center;-webkit-flex-shrink:0;-ms-flex-negative:0;flex-shrink:0;height:100%;position:relative;-webkit-transition-property:-webkit-transform;transition-property:-webkit-transform;-o-transition-property:transform;transition-property:transform;transition-property:transform,-webkit-transform;box-sizing:border-box}mip-chuangyejia-tabs .tabs-nav-wrapper li.active{color:firebrick;border-bottom:2px solid firebrick}");
            }
            if (window.MIP) {
